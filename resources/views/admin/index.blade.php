        ...
        <form action="{{ route('pengguna.store') }}" method="POST"> 
            ...
            <div class=" card-body"> 
                ...
                <div class="form-group"> 
                    ...
                    <input type="email" class="form-control @error('email') isinvalid @enderror" id="email" name="email" placeholder="JohnDoe@example.com" required value="{{ old('email') }}"> 
                    @error('email') 
...
<!-- Toastr --> <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></s cript> 
